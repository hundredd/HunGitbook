...
@interface HFormEditUnit ()<HValueViewDelegate,HDateAlertDelegete,HPickerDelegate>
...
@property(nonatomic,assign)HFormEditUnitStyle style;
...
{
    _limitNum = limitNum;
    [self.textField setInputMaxLength:limitNum];
}
...
-(HInputField *)textField
{
    ...
    if (!_textField) {
        ...
        switch (self.style) {
            ...
            case TextFieldNomalHFormEditUnitStyle:
                textField = [HInputFieldFactory getHInputFieldWithType:QHInputFieldType_Text1];
                break;
            case TextFieldNumHFormEditUnitStyle:
                textField = [HInputFieldFactory getHInputFieldWithType:QHInputFieldType_Decimal2];
                break;
            case TextFieldNumDocHFormEditUnitStyle:
                textField = [HInputFieldFactory getHInputFieldWithType:QHInputFieldType_Cash5];
                break;
            default:
                break;
        }
