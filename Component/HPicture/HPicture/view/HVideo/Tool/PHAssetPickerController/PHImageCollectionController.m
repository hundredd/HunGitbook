...
- (void)initView {
    ...
    CGFloat nomalH = 0;//64
    UICollectionView *collectionView = [[UICollectionView alloc] initWithFrame:CGRectMake(0, nomalH, CGRectGetWidth(self.view.frame), CGRectGetHeight(self.view.frame)-nomalH) collectionViewLayout:layout];
...
- (void)collectionView:(UICollectionView *)collectionView didSelectItemAtIndexPath:(NSIndexPath *)indexPath {
    ...
    {
        if (selectAssets.count<self.maxNum) {
        ...
        {
            NSLog([NSString stringWithFormat:@"最多只可操作%ld个影像",self.maxNum]);
//            [self.view makeToast:[NSString stringWithFormat:@"最多只可操作%ld个影像",self.maxNum]];
        }
    }
